class TestDouble {
	...
	if (c != null) {
	    System.out.println("pb with get() 1");
	}
	c = liste.get(99); // accès en dehors -> renvoie null
	if (c != null) {
	    System.out.println("pb with get() 2");
	}
	c = liste.get(1); // accès indice 1 (i.e 30)
	if (c.value != 30) {
	    System.out.println("pb with get() 3");
	}
	c = liste.find(99); // value inexsitante -> renvoie null
	if (c != null) {
	    System.out.println("pb with find() 1");
	}
	c = liste.find(20); 
	if (c.value != 20) {
	    System.out.println("pb with find() 2");
	}
	c = liste.find(50); 
	if (c.value != 50) {
	    System.out.println("pb with find() 3");
	}
    }
}