...
//        codeSecret = CodeSecret.createCode(random);
        ...
        codeSecret = CodeSecret.createCode();
        System.out.println(codeSecret.revelerCode());
    }

    @Test
    public void testInitialisation() {
        Assertions.assertNotNull(codeSecret, "L'instance de CodeSecret est null !");
    }
...
//        CodeSecret codeSecret = CodeSecret.createCode();
