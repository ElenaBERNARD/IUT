...
public class CodeSecret {
     ...
     * @-param random Un générateur de nombres aléatoires utilisé pour générer chaque chiffre du code secret. (désactivé)
     */
//    public static CodeSecret createCode(MyRandom random) {
    public static CodeSecret createCode() {
...
//        return new CodeSecret(pinCode.toString());
    ...
    // TODO : modifier (bouchon), if code = "1234" return true sinon false
