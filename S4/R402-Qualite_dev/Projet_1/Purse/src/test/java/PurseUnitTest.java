...
//    private String codeJuste = "1234";  // Code secret valide pour les tests
...
//        Purse purse = new Purse(100, 100, mockPinCode);  // Créer un portefeuille avec un plafond de 100
        Purse purse = new Purse(100, 100, new CodeSecret("1234"));
...
//        Purse purse = new Purse(50, 100, mockPinCode);  // Créer un portefeuille avec un plafond de 100
        Purse purse = new Purse(50, 100, new CodeSecret("1234"));
        double solde = purse.getSolde();
